...
{
  fill_convert_request_operation          = 0x000000001,
  author_reward_operation                 = 0x000000002,
  curation_reward_operation               = 0x000000004,
  comment_reward_operation                = 0x000000008,
  liquidity_reward_operation              = 0x000000010,
  interest_operation                      = 0x000000020,
  fill_vesting_withdraw_operation         = 0x000000040,
  fill_order_operation                    = 0x000000080,
  shutdown_witness_operation              = 0x000000100,
  fill_transfer_from_savings_operation    = 0x000000200,
  hardfork_operation                      = 0x000000400,
  comment_payout_update_operation         = 0x000000800,
  return_vesting_delegation_operation     = 0x000001000,
  comment_benefactor_reward_operation     = 0x000002000,
  producer_reward_operation               = 0x000004000,
  clear_null_account_balance_operation    = 0x000008000,
  proposal_pay_operation                  = 0x000010000,
  sps_fund_operation                      = 0x000020000,
  hardfork_hive_operation                 = 0x000040000,
  hardfork_hive_restore_operation         = 0x000080000,
  delayed_voting_operation                = 0x000100000,
  consolidate_treasury_balance_operation  = 0x000200000,
  effective_comment_vote_operation        = 0x000400000,
  ineffective_delete_comment_operation    = 0x000800000,
  sps_convert_operation                   = 0x001000000,
  expired_account_notification_operation  = 0x002000000,
  changed_recovery_account_operation      = 0x004000000,
  fill_recurrent_transfer_operation       = 0x008000000,
  failed_recurrent_transfer_operation     = 0x010000000
};
