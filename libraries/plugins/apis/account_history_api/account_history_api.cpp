...
struct filtering_visitor
{
  ...
  (sps_convert_operation)(expired_account_notification_operation)(changed_recovery_account_operation)(fill_recurrent_transfer_operation) (failed_recurrent_transfer_operation))
